...
namespace growbox::climate::policy {
namespace {
...
ClimatePolicyRequest clippedImpl(const ClimatePolicyRequest& request) noexcept {
...
ClimatePolicyRequest ruleRequestImpl(const ClimateControllerInput& input) noexcept {
...
ClimatePolicyRequest arbitrate(const ClimatePolicyRequest& raw,
  ...
  ClimatePolicyRequest result = clippedImpl(raw);
...
ClimatePolicyRequest safety(const ClimatePolicyRequest& arbitrated,
                            ...
                            std::uint32_t& interventions) noexcept {
  ClimatePolicyRequest result = clippedImpl(arbitrated);
  interventions = InterventionNone;
  const auto& measurements = input.state.measurements;
  ...
  return clippedImpl(result);
}

void evaluateImpl(const ClimatePolicyRequest& raw, const ClimateControllerInput& input,
                  ClimatePolicyEvaluation& evaluation) noexcept {
  evaluation.raw = clippedImpl(raw);
...
bool finiteRequestImpl(const ClimatePolicyRequest& request) noexcept {
...
ClimatePolicyRequest applyDeadzoneImpl(const ClimatePolicyRequest& raw, float threshold) noexcept {
  ClimatePolicyRequest result = clippedImpl(raw);
