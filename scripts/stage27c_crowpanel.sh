...
for name in   GROWBOX_BLE_TP357_MAC   GROWBOX_BLE_XIAOMI_MAC   GROWBOX_STAGE27_SD_ENABLED   GROWBOX_STAGE27_FLASH_FALLBACK_ENABLED   GROWBOX_SD_CMD0_PRECONDITION   GROWBOX_RF433_LOOPBACK_ENABLED   GROWBOX_RF433_REMOTE_CAPTURE_ENABLED   GROWBOX_RF433_TX_GPIO   GROWBOX_RF433_RX_GPIO   GROWBOX_EINK_DISPLAY_ENABLED   GROWBOX_STAGE28_SERVICE_CONSOLE_ENABLED   GROWBOX_STAGE28_REAL_OUTPUTS_ENABLED   GROWBOX_STAGE28_THERMAL_TEST_SEQUENCE_ENABLED   GROWBOX_STAGE28E_BREADCRUMB_RESTART_SELFTEST; do
