...
RUNTIME_VALUE_MACROS = (
    ...
    "GROWBOX_EINK_SCLK_GPIO",
    "GROWBOX_EINK_MOSI_GPIO",
    "GROWBOX_EINK_CS_GPIO",
    "GROWBOX_EINK_DC_GPIO",
    "GROWBOX_EINK_RST_GPIO",
    "GROWBOX_EINK_BUSY_GPIO",
    "GROWBOX_EINK_POWER_GPIO",
...
for forbidden in (
    ...
    "GROWBOX_EINK_SCLK_GPIO=12",
    "GROWBOX_EINK_MOSI_GPIO=11",
    "GROWBOX_EINK_CS_GPIO=45",
    "GROWBOX_EINK_DC_GPIO=46",
    "GROWBOX_EINK_RST_GPIO=47",
    "GROWBOX_EINK_BUSY_GPIO=48",
    "GROWBOX_EINK_POWER_GPIO=7",
):
